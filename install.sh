...
install_x-ui() {
    ...
    wget --no-check-certificate -O /usr/bin/x-ui https://raw.githubusercontents.com/pandafile/x-ui-yg/main/x-ui.sh
...
red "x-ui安装失败，请查看日志，运行 x-ui log，反馈到https://github.com/kkkyg/x-ui-yg/issues"
fi
    sleep 1
    echo -e ""
    echo -e "$int"
